...
var inputString = `493	458	321	120	49	432	433	92	54	452	41	461	388	409	263	58
...
inputString = '[\n[' + inputString.replace(/\t/g, ',').replace(/\n/g, '],\n[');
inputString = inputString.substr(0, inputString.length - 3) + '\n]';
